...
exports.SketchIndex = exports.SketchIndexBase = void 0;
const sketch_primitive_js_1 = require("./sketch_primitive.js");
class SketchIndexBase {
    ...
    get_constraints() {
        return this.get_primitives().filter(o => !(0, sketch_primitive_js_1.is_sketch_geometry)(o));
    }
    toString() {
        return this.get_primitives().map(o => JSON.stringify(o)).join('\n');
    }
}
exports.SketchIndexBase = SketchIndexBase;
class SketchIndex extends SketchIndexBase {
    constructor() {
        super(...arguments);
        this.index = new Map();
        this.primitive_ids = [];
...
exports.SketchIndex = SketchIndex;
