...
exports.property_offsets = void 0;
exports.property_offsets = {
    point: {
        x: 0,
        y: 1
    },
...
function get_property_offset(primitive_type, property_key) {
    const primitive_offsets = exports.property_offsets[primitive_type];
...
exports.default = get_property_offset;
